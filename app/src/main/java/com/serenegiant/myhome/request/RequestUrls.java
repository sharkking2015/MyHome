...
public class RequestUrls {
    ...
    public static final String url_user = "http://192.168.0.10:8080/demo/";
//    public static final String url_user = "http://schbd.zxyq.com.cn/syncMac/";
     ...
     * @return
     */
    public static String getTestPicPath(){
        String path = Environment.getExternalStorageDirectory()+ File.separator+"OutSchoolBigData";
        File file = new File(path);
        if(!file.exists() || !file.isDirectory()){
            file.mkdir();
        }
        return path+ File.separator+"test_pic";
    }
    ...
    public static String getDocPath(){
        ...
        return path+ File.separator+"paper_docs";
    }
     ...
     * @return
     */
    public static String getErrPicPath(){
        String path = Environment.getExternalStorageDirectory()+ File.separator+"OutSchoolBigData";
        File file = new File(path);
        if(!file.exists() || !file.isDirectory()){
            file.mkdir();
        }
        return path+ File.separator+"error_pic";
    }
